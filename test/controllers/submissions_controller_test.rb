...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { body: @submission.body, lead: @submission.lead, title: @submission.title } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { body: @submission.body, lead: @submission.lead, title: @submission.title } }
